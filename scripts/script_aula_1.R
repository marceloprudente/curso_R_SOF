...
# identificar os argumentos das funções
args(log)

# exemplos de como operar funções
example(log)
...
# além de elaborar tabelas de contingência
table(letras)


#--------------------------------------------
# comandos matemáticos no R - operações vetorizadas ----
# Multiplicar vetor
num_dbl * 5
...
#---------------------------------------------
# Aplicando multiplas funções de uma vez -----
...
# e também character únicos 
df[, "cidade"] <- "Brasília"

# além de utilizar sequencias
df$grupo <- rep(c(1, 2), each = 3)


#--------------------------------------------
# Exercicio em sala
# os pacotes do R já carregam bases de dados
library(tidyverse)
# verificar dados já existentes no R. cada pacote tem algumas bases
data()
