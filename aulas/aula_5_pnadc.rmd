...
# fixar diretório
setwd("C:/curso_r/dados/PNADC")
pnadc <- read_pnadc("PNADC_2019_entr1.txt", "Input_PNADC_1entr_2019.txt")
pnadc <- pnadc_labeller(pnadc, "dicionario_PNAD_CONTINUA_MICRODADOS_1_visita_2019.xls")
deflator <- readxl::read_excel("deflator_2019_pnadc.xls")
```
